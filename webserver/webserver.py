    ...
    return_str = pages.w3_style + pages.dashboard_head + draw_top_div() + """
            <div class='main'>
                <div class='w3-sidebar w3-bar-block' style='width:250px; background-color:#1F1F1F'>
                    ...
                    <a href="intrusion_detection" class="w3-bar-item w3-button"><img src="/static/security-icon-64x64.png" alt="Intrusion Detection" style="width:47px;height:32px;padding:0px 15px 0px 0px;float:left"><p style='font-family:"Roboto", sans-serif; font-size:20px; color:white;margin: 2px 0px 0px 0px'>Intrusion Detection</p></a>
