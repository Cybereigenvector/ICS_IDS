        ...
        return_str += """
                        ...
                        <div id="log" class="tab-content" style="display:none;">
                            <div class="detection-logs">
                                ...
                                [2025-05-13 16:46:32] User login: admin<br>
                            </div>
                        </div>
                    </div>
                </div>
