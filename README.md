...
[![Build status](https://ci.appveyor.com/api/projects/status/ut3u3wnvksumi49j?svg=true)](https://ci.appveyor.com/project/thiagoralves/openplc-v3)
...
When using Ubuntu: make sure [docker for Ubuntu](https://docs.docker.com/install/linux/docker-ce/ubuntu/) is installed

When using Linux Mint 21: make sure [docker for Linux Mint 21](https://linuxhint.com/install-docker-linux-mint/) is installed
...
## Enhanced with Intrusion Detection System (IDS)

This fork includes an integrated intrusion detection system with visualization capabilities for industrial control systems.
